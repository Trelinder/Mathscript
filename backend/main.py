...
AZURE_ANALOGY_MODEL = os.environ.get("AZURE_ANALOGY_MODEL", "gpt-nano")        # Teaching analogies (GPT Nano)
AZURE_STORY_MODEL = os.environ.get("AZURE_STORY_MODEL", "gpt-nano")            # Story generation (GPT Nano)
