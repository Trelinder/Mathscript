...
const HERO_SPRITES = {
  Arcanos: { color: '#a855f7', particleShapes: ['star', 'diamond', 'circle'], action: 'casting a spell', moves: 'spell', img: `${BASE}/images/hero-arcanos.png` },
  Blaze: { color: '#f97316', particleShapes: ['bolt', 'cross', 'diamond'], action: 'powering up', moves: 'punch', img: `${BASE}/images/hero-blaze.png` },
  Shadow: { color: '#64748b', particleShapes: ['diamond', 'circle', 'star'], action: 'throwing stars', moves: 'dash', img: `${BASE}/images/hero-shadow.png` },
  Luna: { color: '#ec4899', particleShapes: ['star', 'circle', 'diamond'], action: 'casting lunar magic', moves: 'magic', img: `${BASE}/images/hero-luna.png` },
  Titan: { color: '#22c55e', particleShapes: ['cross', 'bolt', 'diamond'], action: 'smashing', moves: 'smash', img: `${BASE}/images/hero-titan.png` },
  Webweaver: { color: '#ef4444', particleShapes: ['diamond', 'star', 'circle'], action: 'slinging webs', moves: 'swing', img: `${BASE}/images/hero-webweaver.png` },
  Volt: { color: '#dc2626', particleShapes: ['bolt', 'diamond', 'star'], action: 'charging a venom blast', moves: 'venom', img: `${BASE}/images/hero-volt.png` },
  Tempest: { color: '#3b82f6', particleShapes: ['bolt', 'star', 'cross'], action: 'summoning a storm', moves: 'storm', img: `${BASE}/images/hero-tempest.png` },
  Zenith: { color: '#f59e0b', particleShapes: ['bolt', 'star', 'diamond'], action: 'powering up dark ki', moves: 'punch', img: `${BASE}/images/hero-zenith.png?v=2` },
}
