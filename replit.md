...
- 2026-02-13: RPG-style battle scenes for mini-games — hero vs boss arena with health bars, attack animations, damage numbers, screen shake, impact flash. Boss names (Algebrakk, Divisaurus, etc.). Victory sequence with gold reward.
